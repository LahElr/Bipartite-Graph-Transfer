...
class MultiHeadAttentionLayer(nn.Module):
    ...
    def forward(self, g, h):
        ...
        lahelr_print("Q_h,K_h,V_h :", Q_h.shape, K_h.shape, V_h.shape)
        ...
        lahelr_print("attention layer returns: h_out and e_out",
...
class GraphTransformerLayer(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, num_heads, dropout=0.0, layer_norm=False, batch_norm=True, residual=True, use_bias=False):
        ...
        self.attention = MultiHeadAttentionLayer(
            in_dim, out_dim//num_heads, num_heads, self.feat_size, self.weight_size, use_bias)
    ...
    def forward(self, g, h):
        lahelr_print("g,h when in the transformer layer:", g, h.shape)
        ...
        lahelr_print(
            "g,h when in the transformer layer, after 2nd residual:", g, h.shape)
        ...
        lahelr_print(
            "g,h when in the transformer layer, after FEN:", g, h.shape)
        ...
        lahelr_print("g,h that transformer layer returns", g, h.shape)
